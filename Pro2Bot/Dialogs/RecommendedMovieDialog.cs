...
{
    public class RecommendedMovieDialog : ComponentDialog
    {
        public RecommendedMovieDialog() : base(nameof(RecommendedMovieDialog))
        {
        ...
        private async Task<DialogTurnResult> RecommendMovieAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            using (var httpClient = new HttpClient { BaseAddress = baseAddress })
            {
                ...
                using (var response = await httpClient.GetAsync("movie/popular?api_key=265b44f5f18cefae943f3f30ec973d54&language=en-US&page=1"))
                {
                    ...
                    var model = JsonConvert.DeserializeObject<RecommendationRootObject>(responseData);
            ...
            await stepContext.Context.SendActivityAsync(MessageFactory.Text("Here are our recommended movies"), cancellationToken);
        ...
        public class RecommendationRootObject
        {
